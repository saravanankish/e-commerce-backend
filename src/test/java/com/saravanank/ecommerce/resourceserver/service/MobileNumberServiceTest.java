...
public class MobileNumberServiceTest {
	...
	public void addMobileNumber_throwException() {
		...
		assertThrows(NotFoundException.class, () -> contactService.addMobileNumber("invalid", contact2), "User with username invalid not found");
	}
	...
	public void deleteMobileNumber_throwException() {
		...
		assertThrows(NotFoundException.class, () -> contactService.deleteMobileNumber(4), "Mobile number with id 4 not found");
	}
