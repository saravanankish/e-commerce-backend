...
public class OrderServiceTest {
	...
	User testUser2 = new User(2, "User 2", "user2@gmail.com", "user2", "user2", Role.CUSTOMER, true, currentDate,
			currentDate, new ArrayList<MobileNumber>(), null, null);
	Order order1 = new Order(1, 100, currentDate, null, null, null, null, currentDate, 8, 108, false, null, PaymentType.CASH_ON_DELIVERY, testUser1, testUser1, OrderStatus.PENDING_PAYMENT	, null);
	Order order2 = new Order(2, 200, currentDate, null, null, null, null, currentDate, 8, 216, false, null, PaymentType.CASH_ON_DELIVERY, testUser2, testUser2, OrderStatus.PENDING_PAYMENT	, null);
	Order order3 = new Order(3, 300, currentDate, null, null, null, null, currentDate, 8, 324, false, null, PaymentType.CASH_ON_DELIVERY, testUser1, testUser1, OrderStatus.PENDING_PAYMENT	, null);
	...
	public void getUserOrders_throwException() {
		...
		assertThrows(NotFoundException.class, () -> orderService.getUserOrders("invalid"), "User with username  not found");
