...
public class ResourceServerConfig {
	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		http.csrf().disable()
				.authorizeRequests(auth -> auth.antMatchers(AUTH_WHITELIST).permitAll().antMatchers(HttpMethod.GET, "/**/products/**").permitAll().antMatchers(HttpMethod.POST, "/**/user/verify/email").permitAll()
